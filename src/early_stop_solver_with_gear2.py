...
class Gear2(FixedGridODESolver):
  ...
  def __init__(self, func, y0, opt, eps = 0, **unused_kwargs):
    ...
    self.dataset = opt['dataset']
    self. att_opt = {'Cora': self.dataset, 'self_loop_weight': 1, 'leaky_relu_slope': 0.2, 'beta_dim': 'vc', 'heads': 1, 'K': 10, 'attention_norm_idx': 0, 'add_source':False, 'alpha_dim': 'sc', 'beta_dim': 'vc', 'max_nfe':1000, 'mix_features': False}
